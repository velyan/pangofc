...
const RUST_LAYOUTS: &[(&str, Layout)] = &[
    ("PangoFcDecoder", Layout {size: size_of::<PangoFcDecoder>(), alignment: align_of::<PangoFcDecoder>()}),
    ("PangoFcDecoderClass", Layout {size: size_of::<PangoFcDecoderClass>(), alignment: align_of::<PangoFcDecoderClass>()}),
];
